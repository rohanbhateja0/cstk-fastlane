...
**Functionality:** Switches the website’s theme upon click, updating the global theme state via the useTheme hook. Includes hover effects with a shadow transition and ARIA labels for accessibility. The current theme determines the displayed icon.

**Screenshots:**

![screenshot](/images/components/component-themeselector-1.png "screenshot")
![screenshot](/images/components/component-themeselector-2.png "screenshot")
